...
// IPRODUCT[] C'EST L'ENSEMBLE DES PRODUITS

export const PRODUCTS: IProductsByCategory[] = [
  {
    id: 1,
    titre : "Les Pizzas della Mamma",
    category: "pizza",
    products: [
      {
        id: 1,
  ...
  {
    id: 2,
    titre : "Les Boissons della Mamma",
  ...
  {
    id: 3,
    titre : "Les Desserts della Mamma",
    category: "dessert",
    products: [
      {
        id: 12,
